    ...
    class NES
    {
        ...
        public void Run()
        {
            while(true)
            {
                ...
                Console.Write($"{R.PC_str} {opCode.ToString("X2")}: ");
                switch (opCode)
                {
                    // 0x1-
                    case 0x10:
                        ...
                        Console.WriteLine($"BPL #{tmpByte.ToString("X2")}");
                        break;
                    ...
                    case 0x20:
                        ...
                        PushStack(R.PC);
                        R.PC = tmpPC;
                        Console.WriteLine($"JSR ${tmpPC.ToString("X4")}");
                        continue;
                    ...
                    case 0x85:
                        tmpByte = GetPrgVal8();
                        MEM[tmpByte] = R.A;
                        Console.WriteLine($"STA $00{tmpByte.ToString("X2")}");
                        break;
                    case 0x86:
                        tmpByte = GetPrgVal8();
                        MEM[tmpByte] = R.X;
                        Console.WriteLine($"STX $00{tmpByte.ToString("X2")}");
                        break;
                    case 0x8D:
                        tmpPC = GetPrgVal16();
                        MEM[tmpPC] = R.A;
                        Console.WriteLine($"STA ${tmpPC.ToString("X4")}");
                        break;
                    ...
                    case 0x91:
                        tmpByte = GetPrgVal8();
                        MEM[tmpByte + R.Y] = R.A;
                        Console.WriteLine($"STA #{tmpByte.ToString("X2")},{R.Y_str}");
                        break;
                    case 0x9A:
                        R.SP = R.X;
                    ...
                    case 0xAD:
                        ...
                        R.SR.N = (sbyte)R.A < 0; // Set SR negative flag
                        R.SR.Z = R.A == 0; // Set SR zero flag
                        Console.WriteLine($"LDA ${tmpPC.ToString("X4")}");
                        break;
                    ...
                    case 0xB0:
                        ...
                        Console.WriteLine($"BCS #{tmpByte.ToString("X2")}");
                        break;
                    case 0xBD:
                        tmpPC = GetPrgVal16();
                        R.A = MEM[tmpPC+R.X];
                        Console.WriteLine($"LDA ${tmpPC.ToString("X4")},{R.X_str}");
                        break;
                    ...
                    case 0xC9:                        
                        ...
                        Console.WriteLine($"CMP #{tmpByte.ToString("X2")}");
                        break;
                    case 0xCA:
                        R.X--;
                        R.SR.N = (sbyte)R.X < 0;
                    ...
                    case 0xD0:
                        ...
                        Console.WriteLine($"BNE #{tmpByte.ToString("X2")}");
                        break;
                    case 0xD8:
                        R.SR.D = false;
                    ...
                    case 0xE0:
                        ...
                        Console.WriteLine($"CPX #{tmpByte.ToString("X2")}");
                        break;

                    default:
                        Console.WriteLine("Unknown op code:");
                        Console.WriteLine($"{R.PC_str}: {opCode.ToString("X2")}");
                        return;
                }
                R.PC++;
            }
